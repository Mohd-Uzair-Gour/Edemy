...
const CourseDetails = () => {
  ...
  const enrollCourse = async () => {
    try {
      ...
      const {data} = await axios.post(backendUrl + '/api/user/purchase',{courseId:courseData._id},{headers:{Authorization:token}})
      if(data.success){
  ...
  return courseData ? (
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-16 text-left">
        ...
        <div className="max-w-xl z-10 text-gray-500">
          ...
          <div className="flex space-x-2 items-center pt-3 pb-1 text-sm">

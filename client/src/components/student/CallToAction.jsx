...
const CallToAction = () => {
  return (
    <div className='flex flex-col items-center gap-4 pt-10 pb-24 px-8 m:px-0'>
      <h1 className='text-xl md:text-4xl text-gray-800 font-semibold'>Learn anything ,anytime,anywhere </h1>
      <p className='text-gray-500 sm:text-sm'>Incidiunt sint fugiat pariaur cupidant consecteutr sit cillum anim id veniam aliqua prodient expceteur commodo do ea.</p>
